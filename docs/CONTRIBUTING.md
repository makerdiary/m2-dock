...
If you found a bug in the source code, you can help us by submitting an issue to the [issue tracker](https://github.com/makerdiary/m2-dock/issues) in our GitHub repository. Even better, you can submit a Pull Request with a fix.
